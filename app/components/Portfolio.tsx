...
type PortfolioFilter = "all" | "lawns" | "paving" | "gardens";

const PORTFOLIO = [
  { id: 1, tag: "lawns",   title: "Sandton Residential",     img: "https://images.unsplash.com/photo-1594498653385-d5172c532c00?w=800&h=600&fit=crop&auto=format", span: "col-span-2 row-span-2" },
  { id: 2, tag: "paving",  title: "Rosebank Driveway",       img: "https://images.unsplash.com/photo-1780216200639-47d28549d04e?w=600&h=400&fit=crop&auto=format", span: "" },
  { id: 3, tag: "gardens", title: "Midrand Garden Suite",    img: "https://images.unsplash.com/photo-1777454765997-8a4a6b98f760?w=600&h=400&fit=crop&auto=format", span: "" },
  { id: 4, tag: "paving",  title: "Centurion Courtyard",     img: "https://images.unsplash.com/photo-1702308632273-711147c3e648?w=600&h=500&fit=crop&auto=format", span: "" },
  { id: 5, tag: "lawns",   title: "Bryanston Estate",        img: "https://images.unsplash.com/photo-1597201278257-3687be27d954?w=600&h=400&fit=crop&auto=format", span: "" },
...
export default function Portfolio({ showFilters = true }: { showFilters?: boolean }) {
  ...
  const visible = filter === "all" ? PORTFOLIO : PORTFOLIO.filter(p => p.tag === filter);
...
function PortfolioItem({ item, isLarge }: { item: typeof PORTFOLIO[0]; isLarge: boolean }) {
